...
def handle_scaling(age, df):
    ...
    if age <= 25:
        scaler_object = scaler_insurance
    else:
        scaler_object = scaler_insurance_old
...
def predict(input_dict):
    ...
    if input_dict['Age'] <= 25:
        prediction = model_insurance.predict(input_df)
    else:
        prediction = model_insurance_old.predict(input_df)
